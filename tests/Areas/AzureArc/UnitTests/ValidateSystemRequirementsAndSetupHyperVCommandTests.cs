...
[Trait("Area", "AzureArc")]
public sealed class ValidateSystemRequirementsAndSetupHyperVCommandTests
{
    ...
    public async Task ExecuteAsync_ValidParameters_ReturnsSuccess()
    {
        ...
        Assert.Contains("System requirements validated and Hyper-V setup completed successfully", response.Message);
    }
    ...
    public async Task ExecuteAsync_ServiceReturnsFalse_ReturnsError()
    {
        ...
        {
            Success = false,
            Steps = "Failed to validate system requirements and setup Hyper-V"
        };
        ...
        Assert.Contains("Failed to validate system requirements and setup Hyper-V", response.Message);
    }
    ...
    public async Task ExecuteAsync_CallsServiceWithCorrectParameters()
    {
        ...
        // Assert
        await _arcService.Received(1).ValidateSystemRequirementsAndSetupHyperVAsync(userProvidedPath);
    }
