...
- Support for Azure SQL Server Active Directory administrator operations - List Azure Active Directory administrators for a SQL server. [#529](https://github.com/Azure/azure-mcp/pull/529)
### Breaking Changes
