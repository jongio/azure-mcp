...
public sealed class QuickDeployAksEdgeEssentialsCommand : BaseSubscriptionCommand<ArcConnectOptions>
{
    ...
    public QuickDeployAksEdgeEssentialsCommand(
        ILogger<QuickDeployAksEdgeEssentialsCommand> logger,
    ...
    public override async Task<CommandResponse> ExecuteAsync(CommandContext context, ParseResult parseResult)
    {
        try
        {
            ...
            var result = await _arcService.QuickDeployAksEdgeEssentialsAsync(
                options.ClusterName!,
